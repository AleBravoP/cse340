...
(
    ...
    CONSTRAINT comments_inv_id_fkey FOREIGN KEY (inv_id) REFERENCES public.inventory (inv_id) ON DELETE CASCADE,
    CONSTRAINT comments_account_id_fkey FOREIGN KEY (account_id) REFERENCES public.account (account_id) ON DELETE CASCADE
);
